...
const bufferFrom = Buffer.from('hi there'); // creates a buffer from a string and gives you the hex codes for each char
console.log(bufferFrom);

const smile = Buffer.from([0xF0, 0x9F, 0x98, 0x8D]); // gives you heart eyes emoji
